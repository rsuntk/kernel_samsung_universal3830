...
ifneq "$(NM)" "/rsuntk/toolchains/aarch64-linux-android/bin/aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/rsuntk/toolchains/aarch64-linux-android/bin/aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/rsuntk/toolchains/aarch64-linux-android/bin/ --gcc-toolchain=/rsuntk/toolchains/aarch64-linux-android -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
